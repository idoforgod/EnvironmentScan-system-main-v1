...
| 경고 수준 | 신호 수 | 핵심 신호 |
|-----------|---------|----------|
| ORANGE | 2 | 트럼프-네타냐후, 이란 대중국 석유수출 차단 합의 -- '협상 결렬시 이스라엘 이란 공격 지지', 중국 비밀 핵시설 확장 + 유럽 '핵 억지' 자립 선언 -- 글로벌 핵확산 '뉴 노멀' 진입 |
| YELLOW | 4 | 미 국방부 앤트로픽 AI 윤리 완화 요구 -- '계약 해지' 최후통첩으로 AI 군사화 본격화, 부동산 정책 정면 드라이브 -- 52% '효과 있을 것' vs 야당 '사회주의' 반발, 설 민심 격전, 김주애 후계 공식화 가능성 + 김정은 러 파병 전사자 주택 준공 -- 북한 체제 전환 신호 다중 발생 외 1건 |
...
| Precursor Event | 2 | {{FSSF_DIST_PE_REPR}} | {{FSSF_DIST_PE_NOTE}} |
