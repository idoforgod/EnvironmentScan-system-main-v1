...
> **Scan Window**: February 25, 2026 21:36 UTC ~ February 26, 2026 21:36 UTC (24 hours)
> **Anchor Time (T₀)**: February 26, 2026 21:36:37 UTC
...
- Sites crawled: {{TOTAL_SITES_CRAWLED}} sites, {{TOTAL_SITES_SUCCEEDED}} succeeded, {{TOTAL_SITES_FAILED}} failed
- Language breakdown: {{BY_LANGUAGE_KO}} Korean, {{BY_LANGUAGE_EN}} English, {{BY_LANGUAGE_ZH}} Chinese, {{BY_LANGUAGE_JA}} Japanese, {{BY_LANGUAGE_DE}} German, {{BY_LANGUAGE_FR}} French, {{BY_LANGUAGE_RU}} Russian, {{BY_LANGUAGE_OTHER}} Other
- Translation: {{TRANSLATION_TOTAL}} translated, {{TRANSLATION_FAILED}} failed
...
| Total Sites Crawled | {{TOTAL_SITES_CRAWLED}} |
| Sites Succeeded | {{TOTAL_SITES_SUCCEEDED}} |
| Sites Failed | {{TOTAL_SITES_FAILED}} |
...
| Item | Value |
|------|-------|
| Total Translated | {{TRANSLATION_TOTAL}} |
| Translation Failed | {{TRANSLATION_FAILED}} |
| By Language — Korean | {{BY_LANGUAGE_KO}} |
| By Language — English | {{BY_LANGUAGE_EN}} |
| By Language — Chinese | {{BY_LANGUAGE_ZH}} |
| By Language — Japanese | {{BY_LANGUAGE_JA}} |
| By Language — German | {{BY_LANGUAGE_DE}} |
| By Language — French | {{BY_LANGUAGE_FR}} |
| By Language — Russian | {{BY_LANGUAGE_RU}} |
| By Language — Other | {{BY_LANGUAGE_OTHER}} |
